...
function [svm_weak, feature, error, alpha_weak, W_out, res_out, G_out] = select_svm(fv, N, rect, neg_info, pos_info, W_in)
...
%   POS_INFO, PATH_TO_RID, PATH_TO_POSITIVES, PATH_TO_NEGATIVES, WEIGTHS)
    ...
    for i=1:N     
        ...
        options.MaxIter = inf;
        try
            svm = svmtrain(T,G, 'Options', options, 'boxconstraint', 0.5);
